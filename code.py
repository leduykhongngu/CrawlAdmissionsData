...
Prefix = "http://sgdbinhduong.edu.vn/Tracuudiem/Tuyensinh10/tabid/294/NamThi/2020/DotThiId/34/ThiSinhId/"
Suffix = "/Default.aspx"
Line = [u'Tên', u'SBD', u'Ngày sinh', u'Giới Tính', u'Nơi sinh', u'Trường', u'Nguyện vọng 1', u'Nguyện vọng 2', u'Chuyên 1',
        u'Chuyên 2', u'Điểm ưu tiên', u'Văn', u'Anh', u'Toán', u'Chuyên 1', u'Chuyên 2', u'Tổng', u'Tổng chuyên 1', u'Tổng chuyên 2']
with open('Tuyensinh10.csv', 'ab') as writeFile:
    ...
    for i in range(L, R+1):
        ...
        writer.writerow([Test.name, Test.SBD, Test.birthday, Test.sex, Test.BornIn, Test.SecSchool, Test.nv1, Test.nv2, Test.nvC1,
                         Test.nvC2, Test.PriorityPoints, Test.SVan, Test.SAnh, Test.SToan, Test.SC1, Test.SC2, Test.SumTVA, Test.SumC1, Test.SumC2])

...
Line = [u"Tên", u"SBD", u"Ngày sinh", u"Giới Tính", u"Nơi sinh", u"Trường", u"Nguyện vọng 1",
...
with open("Tuyensinh10.csv", "ab") as writeFile:
    ...
    for i in range(L, R+1):
        ...
        writer.writerow([Test.name, Test.SBD, Test.birthday, Test.sex, Test.BornIn, Test.SecSchool,
                         Test.nv1, Test.nv2, Test.nvC1, Test.nvC2, Test.PriorityPoints, Test.SVan,
                         Test.SAnh, Test.SToan, Test.SC1, Test.SC2, Test.SumTVA, Test.SumC1, Test.SumC2])
